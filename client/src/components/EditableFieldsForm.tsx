...
const EditableFieldsForm = ({
  extractedData,
  onUpdate,
}: EditableFieldsFormProps) => {
  const [formData, setFormData] =
    useState<Partial<ExtractedData>>(extractedData);
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="pb-4 border-b border-gray-100">
          ...
          {isEditing ? (
            <input
              ...
              onChange={(e) =>
                handleFieldChange("invoiceDate", e.target.value || undefined)
              }
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ) : (
        ...
        <div className="pb-4 border-b border-gray-100">
          ...
          {isEditing ? (
            ...
            <p className="text-base font-medium text-gray-900">
              {formatCurrency(formData.amountSubtotal, formData.currency) ||
                "N/A"}
            </p>
          )}
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="pb-3 border-b border-gray-100">
              ...
              {isEditing ? (
                ...
                <p className="text-base font-medium text-gray-900">
                  {formatCurrency(
                    formData.taxInformation?.taxAmount,
                    formData.currency,
                  ) || "N/A"}
                </p>
              )}
